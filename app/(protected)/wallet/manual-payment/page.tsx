        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <p className="text-gray-600">
                Welcome to the manual payment section of our application!
              </p>
            </div>
            <button
              onClick={logout}
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li>✅ Generate payment confirmation</li>
                <li>✅ Update transaction history</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
            ...
            <p className="text-blue-700 mb-4">
              This section allows authorized users to process manual payments.
            </p>
            <ul className="list-disc list-inside text-blue-700 space-y-1">
              <li>Payment details entry form</li>
              <li>Verification tools</li>
              <li>Confirmation generation</li>
            </ul>
          </div>
