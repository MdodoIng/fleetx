        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <p className="text-gray-600">
                Welcome to the vendor list section of our application!
              </p>
            </div>
            <button
              onClick={logout}
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li>✅ Search for specific vendors</li>
                <li>✅ Filter vendors by category</li>
                <li>✅ Access vendor details</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
            ...
            <p className="text-blue-700 mb-4">
              This section displays a comprehensive list of all vendors.
            </p>
