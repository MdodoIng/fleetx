        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <p className="text-gray-600">
                Welcome to the bulk insights section of our application!
              </p>
            </div>
            <button
              onClick={logout}
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>✅ Analyze bulk order performance</li>
                <li>✅ Identify trends in bulk orders</li>
                <li>✅ Optimize bulk order strategies</li>
                <li>✅ Access detailed bulk order reports</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
            <h3 className="text-lg font-semibold text-blue-800 mb-3">
              📋 Bulk Insights Content
            </h3>
            <p className="text-blue-700 mb-4">
              This section provides detailed insights into your bulk order data.
            </p>
