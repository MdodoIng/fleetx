        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <p className="text-gray-600">
                Welcome to the protected section of our application!
              </p>
            </div>
            <button
              onClick={logout}
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p>
                  <strong>User ID:</strong> {user?.user.email}
                </p>
              </div>
            </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
            ...
            <p className="text-blue-700 mb-4">
              This is sensitive information that should only be visible to
              authenticated users. Here you might find:
            </p>
            <ul className="list-disc list-inside text-blue-700 space-y-1">
              <li>Personal account details</li>
              <li>Private documents and files</li>
              <li>Billing and subscription information</li>
              <li>Advanced application features</li>
            </ul>
          </div>
